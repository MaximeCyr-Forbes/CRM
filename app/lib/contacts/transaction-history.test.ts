...
function transaction(values: Partial<Transaction> = {}): Transaction {
  return {
    ...
    collaboratingBrokerName: "", saleFinalizedAt: null, status: "new", generalNotes: "", deadlines: [], notes: [],
...
describe("historique immobilier du Contact", () => {
  it("trie du plus récent au plus ancien, déduplique et utilise les dates selon leur priorité", () => {
    ...
    const purchase2026 = transaction({ id: "2026", saleFinalizedAt: "2026-07-01T12:00:00Z", notaryDate: "2026-06-01" });
  ...
  it("calcule uniquement le volume réellement conclu", () => {
    const values = [
      transaction({ id: "purchase-completed", status: "completed", price: 500_000 }),
